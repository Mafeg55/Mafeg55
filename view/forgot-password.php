...
<body onLoad="login()">
	<img src="../uploads/in HU.jpg" class="bg" />
  	...
  	<div class="modal fade" id="loginFrom" tabindex="-1" role="dialog" aria-labelledby="loginFrom" aria-hidden="true">
    	<div class="modal-dialog">    
        	<div class="modal-content ">
                ...
                <form action="controller/Validation.php" method="POST" autocomplete="">
                <div class="form-group" id="divEmail">
                      			<label for="">Email</label>
                      			<input type="text" class="form-control" id="email" placeholder="Enter email address" name="email" autocomplete="off">
                    		</div>
									<button type="submit" name="check-email" value="Continue" class="btn btn-primary mb-4">Continue</button>
								</form>
        		</div>
      		</div>      
		</div>
